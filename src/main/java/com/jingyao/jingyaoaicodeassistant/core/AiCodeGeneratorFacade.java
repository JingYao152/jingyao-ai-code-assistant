...
import com.jingyao.jingyaoaicodeassistant.ai.model.message.AiResponseMessage;
import com.jingyao.jingyaoaicodeassistant.ai.model.message.ToolExecutedMessage;
import com.jingyao.jingyaoaicodeassistant.ai.model.message.ToolRequestMessage;
...
public class AiCodeGeneratorFacade {
	...
	public Flux<String> generateAndSaveCodeStream(String userMessage, CodeGenTypeEnum codeGenTypeEnum, Long appId) {
		...
		AiCodeGeneratorService aiCodeGeneratorService = aiCodeGeneratorServiceFactory.getAiCodeGeneratorService(appId,
			codeGenTypeEnum);        // 根据不同的代码生成类型进行处理
		return switch (codeGenTypeEnum) {
			// 处理HTML代码生成类型
			case HTML -> {
				// 生成HTML代码流
