package com.jingyao.jingyaoaicodeassistant.generator;
...
public class MyBatisCodeGenerator {
	...
	public static void main(String[] args) {
		...
		// 配置数据源，使用 HikariConfig 进行更详细的配置
	...
	public static GlobalConfig createGlobalConfig() {
		...
		globalConfig.getPackageConfig()
			.setBasePackage("com.jingyao.jingyaoaicodeassistant.genresult");
		...
		globalConfig.getJavadocConfig()
			.setAuthor("<a href=\"https://github.com/jingyao152\">JINGYAO</a>")
			.setSince("");
		return globalConfig;
	}
}